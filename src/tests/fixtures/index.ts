...
export function createTestFixture(
  ...
  async function writeUser(partial?: Partial<UserModel>) {
    log(R.isNumber(partial?.id) ? `Creating a user with id: ${partial.id}` : 'Creating a user')
  ...
  async function writeLocation(partial?: Partial<LocationModel>) {
    log(R.isNumber(partial?.id) ? `Creating a location with id: ${partial.id}` : 'Creating a location')
  ...
  async function writeTheme(partial?: Partial<ThemeModel>) {
    log(R.isNumber(partial?.id) ? `Creating a theme with id: ${partial.id}` : 'Creating a theme')
