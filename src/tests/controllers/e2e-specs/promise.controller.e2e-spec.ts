...
describe(PromiseController, () => {
  ...
  const http = createHttpRequest<PromiseController>('promises', {
    ...
    createPromise: '',
    updatePromise: ':pid',
    attendPromise: ':pid/attendees',
    leavePromise: ':pid/attendees',
    delegatePromise: ':pid/delegate',
    completePromise: ':pid/complete',
    getStartLocation: ':pid/start-location',
    updateStartLocation: ':pid/start-location',
    deleteStartLocation: ':pid/start-location',
    getMiddleLocation: ':pid/middle-location',
