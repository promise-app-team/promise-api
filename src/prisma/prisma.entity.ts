...
import {
  type DestinationType as DestinationTypeEnum,
  type LocationShareType as LocationShareTypeEnum,
  Prisma,
  type Provider as ProviderEnum,
} from '@prisma/client'
...
const _userInclude: Prisma.UserInclude = {
  myPromises: true,
  promises: {
...
const _themeInclude: Prisma.ThemeInclude = {
  promises: {
    include: promiseThemeInclude,
  },
}

const _promiseInclude: Prisma.PromiseInclude = {
  host: true,
  attendees: {
    include: promiseUserInclude,
  },
...
const _locationInclude: Prisma.LocationInclude = {
  promises: true,
  promiseUsers: true,
}

const _mutationLogInclude: Prisma.MutationLogInclude = {
  user: true,
}

type UserPayload = Prisma.UserGetPayload<{ include: typeof _userInclude }>
type ThemePayload = Prisma.ThemeGetPayload<{ include: typeof _themeInclude }>
type PromisePayload = Prisma.PromiseGetPayload<{ include: typeof _promiseInclude }>
type LocationPayload = Prisma.LocationGetPayload<{ include: typeof _locationInclude }>
...
type MutationLogPayload = Prisma.MutationLogGetPayload<{ include: typeof _mutationLogInclude }>
