...
export function findGeometricMedian(points: Point[], options?: { precision?: number }): Point {
  if (points.length < 1) throw new Error('Cannot find the geometric median of an empty list of points');
